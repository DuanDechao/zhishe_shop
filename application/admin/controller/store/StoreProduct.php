...
//        if(!$data['keyword']) return Json::fail('请输入产品关键字');
    ...
    public function edit($id)
    {
        ...
        $form = Form::create(Url::build('update',array('id'=>$id)),[
            ...
            Form::frameImageOne('image','产品主图片(305*305px)',Url::build('admin/widget.images/index',array('fodder'=>'image')),$product->getData('image'))->icon('image')->width('100%')->height('550px')->spin(0),
            Form::frameImages('slider_image','产品轮播图(640*640px)',Url::build('admin/widget.images/index',array('fodder'=>'slider_image')), $sliderImage)->maxLength(5)->icon('images')->width('100%')->height('550px')->spin(0),
