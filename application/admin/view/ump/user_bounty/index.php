...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">奖励金日志</div>
                <div class="layui-card-body">
...
<script>
    require(['vue'],function(Vue) {
        new Vue({
            ...
            methods:{
                getUserBountyBadgeList:function(where){
                    var q={},that=this,where=where || {};
                    q.start_time=where.start_time || '';
                    q.end_time=where.end_time || '';
                    q.nickname=where.nickname || '';
                    layList.baseGet(layList.U({c:'ump.user_bounty',a:'getUserBountyBadgeList',q:q}),function (rem) {
                        that.badge=rem.data;
                    });
                }
            },
            mounted:function () {
                this.getUserBountyBadgeList();
                layList.form.render();
                layList.tableList('userList',"{:Url('getbountylist')}",function () {
                    return [
                        {field: 'id', title: 'ID', sort: true,event:'uid',width:'8%'},
                        {field: 'title', title: '标题' },
                        {field: 'balance', title: '奖励金余量',sort:true,event:'now_money'},
                ...
                layList.search('search',function(where){
                    ...
                    that.getUserBountyBadgeList(where);
                });
                layList.search('export',function(where){
                    ...
                    q.end_time=where.end_time || '';
                    q.nickname=where.nickname || '';
                    location.href=layList.U({c:'ump.user_bounty',a:'export',q:q});
                })
            }
        })
    });
