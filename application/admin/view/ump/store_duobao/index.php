    ...
    <div class="layui-row layui-col-space15"  id="app">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">夺宝产品搜索</div>
                <div class="layui-card-body">
                    <div class="alert alert-success alert-dismissable">
                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                        目前拥有{$countDuobao}个夺宝产品
                    </div>
                    <form class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <label class="layui-form-label">夺宝状态：</label>
                                <div class="layui-input-inline">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">夺宝产品列表</div>
                <div class="layui-card-body">
                    <table class="layui-hide" id="duobaoList" lay-filter="duobaoList"></table>
...
<script>
    ...
    function setTime() {
        setTimeout(function () {
            $eb.axios.get("{:Url('get_duobao_id')}").then(function(res){
...
<script>
    layList.form.render();
    layList.tableList('duobaoList',"{:Url('get_duobao_list')}",function () {
        return [
            ...
            {field: 'price', title: '人次单价',width:'6%'},
            {field: 'total_terms', title: '总期数',width:'4%'},
            {field: 'total_portion', title: '总人次',width:'4%'},
            {field: 'cur_term', title: '当前期数',width:'4%'},
            {field: 'cur_portion', title: '参与人次',width:'4%'},
            {field: 'start_name', title: '秒杀状态',width:'7%',toolbar:"#statusCn"},
            {field: 'stop_time', title: '结束时间', width: '13%',toolbar: '#stopTime'},
            {field: 'status', title: '状态',width:'10%',toolbar:"#status"},
            {field: 'right', title: '操作', width: '7%', align: 'center', toolbar: '#barDemo'}
        ]
    });
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'ump.store_duobao',a:'delete',q:{id:data.id}});
    ...
    layList.search('export',function(where){
        location.href=layList.U({c:'ump.store_duobao',a:'save_excel',q:{status:where.status,store_name:where.store_name}});
    })
