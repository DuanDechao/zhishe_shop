...
<script>
    ...
    layList.tableList('userList',"{:Url('get_user_list')}",function () {
        return [
                ...
                {field: 'now_money', title: '余额',width:'5%',sort:true,event:'now_money'},
                {field: 'distribution_money', title: '分销金',width:'6%',sort:true,event:'distribution_money'},
                {field: 'spread_money', title: '推荐金',width:'6%',sort:true,event:'spread_money'},
                {field: 'rebate_money', title: '返利金',width:'6%',sort:true,event:'rebate_money'},
                {field: 'register_money', title: '注册金',width:'6%',sort:true,event:'register_money'},
                {field: 'pay_count', title: '购买次数',align:'center',width:'3%'},
                {field: 'extract_count_price', title: '累计提现',align:'center',width:'3%'},
    ...
    layList.sort(function (obj) {
        ...
        switch (layEvent){
            ...
            case 'now_money':
                ...
                break;
            case 'distribution_money':
                layList.reload({order: layList.order(type,'u.distribution_money')},true,null,obj);
                break;
            case 'spread_money':
                layList.reload({order: layList.order(type,'u.spread_money')},true,null,obj);
                break;
            case 'rebate_money':
                layList.reload({order: layList.order(type,'u.rebate_money')},true,null,obj);
                break;
            case 'register_money':
                layList.reload({order: layList.order(type,'u.register_money')},true,null,obj);
                break;
            case 'integral':
